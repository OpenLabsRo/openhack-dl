...
[ "$OS" = "Linux" ] || die "Unsupported OS '$OS'; hyper-cli currently targets Linux."
[ "$ARCH" = "x86_64" ] || [ "$ARCH" = "amd64" ] || die "Unsupported architecture '$ARCH'; hyper-cli currently targets x86_64."
...
printf "hyper-cli installed to %s\n" "$TARGET"
